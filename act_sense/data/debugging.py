...
def visualize_arena(arena, mouse, aperture):
    ...
    circle1 = patches.Circle((arena.width/2 - 10, arena.height/2), 5, color='green')
    ax.add_patch(circle1)
    art3d.pathpatch_2d_to_3d(circle1, z=arena.length, zdir="y")

    # Plot second circle on the right side
    circle2 = patches.Circle((arena.width/2+ 10, arena.height/2), 5, color='red')
...
aperture = Aperture(arena_width=60, arena_height=50, arena_length=60, gap_width=7)
